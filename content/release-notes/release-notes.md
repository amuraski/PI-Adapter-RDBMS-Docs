...
PI Adapter for RDBMS can also collect health and diagnostics information. It supports buffering, static and event data collection, on demand discovery of available data items on a data source.
